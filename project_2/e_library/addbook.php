    ...
    <div class="grid">
        ...
        <form action="#" method="POST" class="form login">
            ...
            <div class="form__field">
                <input type="text" name="pic" class="form__input" placeholder="URL of book Cover" required>
            </div>
            ...
            <div class="form__field">
                <input type="text" name="book" class="form__input" placeholder="URL of book PDF" required>
            </div>
...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        echo "<script type='text/javascript'>alert('The book ".  $title = $_POST['title'] ." has been uploaded. OK will go home');window.location = 'home.php';</script>";
         }
           /*$uploaddir = 'books/';
